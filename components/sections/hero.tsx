    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl gap-16 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center mt-5">
          ...
          <TypographyAnimation
            text={profile.title}
            className="mt-4 text-2xl font-medium text-violet-300 md:text-3xl"
            delay={0.2}
          />
        ...
        >
          <div className="relative h-[500px] w-[500px] rounded-full border border-white/10 bg-gradient-to-br from-violet-500/20 to-cyan-500/20 backdrop-blur-3xl">
            <div className="absolute inset-2 rounded-full ">
              <Image height={480} width={480} src={profile?.profilePicture} alt="pp" className="border border-white/10 bg-[#0B1120] h-[480px] w-[480px] rounded-full   object-cover overflow-hidden" />
            </div>
